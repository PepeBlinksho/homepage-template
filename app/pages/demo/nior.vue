        ...
        <div class="breads-grid">
          <article class="bread reveal">
            ...
            <div class="meta">
              ...
              <p class="desc">
                石川産小麦とライ麦、能登の海塩。薪窯で一気に焼き上げる、皮は香ばしく、中はしっとりのカンパーニュ。
              </p>
              <div class="tag-row">
                <span class="tag">薪窯</span><span class="tag">ヴィーガン</span>
              </div>
            </div>
          </article>
          <article
