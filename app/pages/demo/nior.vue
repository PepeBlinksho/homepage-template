...
<template>
  ...
  >
    ...
    <header class="site" id="hdr">
      ...
      <a href="#" class="brand" aria-label="NiOR home">
        <div class="word"><em>NiOR</em></div>
        <div class="sub">薪窯ベーカリー — Nonoichi, Ishikawa</div>
      </a>
      <div class="right">
    ...
    <section class="hero" data-screen-label="01 Hero">
      ...
      <div class="hero-content wrap" style="padding-left:var(--gutter);padding-right:var(--gutter)" :style="heroContentStyle">
        <div class="hero-tag reveal">
          <span class="line" />
          <span class="text">石川県野々市市 — 薪窯ベーカリー</span>
        </div>
        <h1 class="display reveal" style="--reveal-delay:120ms">
          <span class="jp-overlay">薪 窯 の パ ン</span>
          炎と粉と、<br>ゆっくりとした<br><em>時間</em>から。
        </h1>
    ...
    <section class="story wrap" id="story" data-screen-label="02 Story">
      <header class="sec-head">
        ...
        <h2 class="display reveal" style="--reveal-delay:100ms">
          薪を焚き、粉と向き合う。<br><em>窯のリズム</em>で焼く。
        </h2>
      </header>
      <div class="story-grid">
        ...
        <div class="copy reveal" style="--reveal-delay:120ms">
          <p class="body-large">
            NiORは、金沢のすぐ隣の街、野々市市の住宅街にある薪窯ベーカリーです。毎朝、薪に火を入れ、窯の温度と対話しながらパンを焼きあげています。
          </p>
          <p class="body-large">
            石川の農家から届く石臼挽きの小麦、能登の海塩、長く育ててきたサワードウ種。薪窯ならではの香ばしさと、ゆっくりとした発酵がつくる、奥深い味わいのパンです。
          </p>
        </div>
        ...
        <div class="story-pull reveal">
          <blockquote>「薪窯は、こちらの都合では焼けません。窯のリズムに合わせて、パンが焼きあがるのを待ちます。」</blockquote>
          <cite>— 店主</cite>
        </div>
      </div>
    </section>
        ...
        <div class="breads-grid">
          <article class="bread reveal">
            ...
            <div class="meta">
              ...
              <p class="desc">石川産小麦とライ麦、能登の海塩。薪窯で一気に焼き上げる、皮は香ばしく、中はしっとりのカンパーニュ。</p>
              <div class="tag-row"><span class="tag">薪窯</span><span class="tag">ヴィーガン</span></div>
            </div>
          </article>
      ...
      <div class="wrap">
        ...
        <div class="cafe-cap">
          ...
          <div class="right body-large reveal" style="--reveal-delay:120ms">
            <p>窯のそばに、小さなイートインスペースを設けています。金沢のロースタリーから届くハンドドリップコーヒーと、焼きたてのパンをそのまま召し上がっていただけます。窯の熱気と薪の香りに包まれた、特別な時間です。</p>
          </div>
        </div>
      ...
      <div class="wrap">
        ...
        <div class="access-grid">
          <div class="map-card reveal">
            ...
            <div class="map-pin">
              <span class="pin-dot" />
              <span class="pin-label">NiOR</span>
            </div>
          </div>
          <dl class="info-block">
            ...
            <div class="info-row reveal">
              <dt>イートイン</dt>
              <dd>ラストオーダー 17:00<br><small>6席・ご来店歓迎。</small></dd>
            </div>
            <div class="info-row reveal">
              <dt>お問い合わせ</dt>
              <dd>076-000-0000<br><small>hello@nior.example.com</small></dd>
            </div>
          </dl>
        </div>
      </div>
    ...
    <section class="insta">
      <div class="wrap">
        <div class="insta-head">
          <h3 class="reveal">日々のひとこま <em>· @nior__</em></h3>
...
.nior-page, .nior-page *, .nior-page *::before, .nior-page *::after {
  box-sizing: border-box;
}
.nior-page a { color: inherit; text-decoration: none; }
.nior-page img { display: block; max-width: 100%; }
.nior-page ::selection { background: #8a6a4a; color: #fdfaf3; }
</style>
...
/* Themes */
.nior-page[data-theme="paper"]   { --cream: #fdfaf3; --cream-2: #f3ecdd; }
.nior-page[data-theme="toasted"] { --cream: #efe4d0; --cream-2: #e2d2b6; --paper: #f6ecd8; }

/* Display fonts */
.nior-page[data-display="playfair"]  { --serif: "Playfair Display", "Noto Serif JP", Georgia, serif; }
.nior-page[data-display="cormorant"] { --serif: "Cormorant Garamond", "Noto Serif JP", Georgia, serif; }
...
.nior-page[data-grain="false"] .grain-overlay { display: none; }
