...
const sections = [
  { title: '個人情報の収集について', body: '当サイトでは、お問い合わせフォームのご利用時に、お名前・メールアドレス・電話番号などの個人情報をご提供いただく場合があります。収集した個人情報は、お問い合わせへの回答および当店からのご連絡にのみ使用いたします。' },
  { title: '個人情報の第三者提供について', body: '当店は、法令に基づく場合を除き、ご本人の同意なしに個人情報を第三者に提供することはありません。' },
  { title: '個人情報の管理について', body: '収集した個人情報は、不正アクセス・紛失・破壊・改ざん・漏洩などを防ぐため、適切な安全管理措置を講じます。保存期間は目的達成後、速やかに削除いたします。' },
  { title: 'アクセス解析について', body: '当サイトでは、サービス改善を目的としてアクセス解析ツールを使用する場合があります。このツールはCookieを使用してアクセス情報を収集しますが、個人を特定する情報は収集しておりません。' },
  { title: 'お問い合わせ・開示請求について', body: '個人情報の開示・訂正・削除・利用停止をご希望の場合は、以下の連絡先までお申し出ください。ご本人確認のうえ、合理的な範囲で対応いたします。' },
  { title: 'プライバシーポリシーの変更について', body: '当店は、必要に応じて本ポリシーを変更することがあります。変更後のポリシーは、当サイトに掲載した時点から適用されます。' },
]
