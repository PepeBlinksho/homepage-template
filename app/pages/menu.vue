...
useSeoMeta({
  title: `メニュー | ${siteConfig.name}`,
  description: `${siteConfig.name}のメニュー一覧です。`,
  ogTitle: `メニュー | ${siteConfig.name}`,
  ogDescription: `${siteConfig.name}のメニュー一覧です。`,
  ogImage: siteConfig.seo.ogImage,
  ogType: 'website',
  twitterTitle: `メニュー | ${siteConfig.name}`,
  twitterDescription: `${siteConfig.name}のメニュー一覧です。`,
  twitterImage: siteConfig.seo.ogImage,
})
useCanonical()
