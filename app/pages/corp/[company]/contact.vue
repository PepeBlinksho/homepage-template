  ...
  <div class="min-h-screen bg-white">
    ...
    <div class="pt-16 relative bg-slate-900 py-20 overflow-hidden">
      ...
      <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        <p class="text-xs tracking-[0.5em] uppercase text-sky-400 mb-3">
          Contact
        </p>
        <h1 class="font-serif text-5xl md:text-6xl font-semibold text-white mb-4">
          お問い合わせ
        </h1>
        <div class="w-12 h-0.5 bg-sky-500" />
        <p class="mt-4 text-slate-400 text-sm">
          無料お見積り・点検のご依頼もお気軽にどうぞ
        </p>
      </div>
    </div>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 py-20">
      ...
      >
        ...
        <h2 class="font-serif text-3xl font-semibold text-slate-900 mb-4">
          送信が完了しました
        </h2>
      ...
      >
        ...
        >
          ...
          <div class="bg-sky-50 border border-sky-100 rounded-2xl p-6 mb-6">
            <p class="text-xs text-sky-600 font-semibold uppercase tracking-wider mb-2">
              お電話でも受け付けています
            </p>
            <a
              :href="`tel:${cfg.tel}`"
          ...
          <h2 class="font-serif text-xl font-semibold text-slate-900 mb-4">
            メールでのお問い合わせ
          </h2>
            ...
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  class="text-sm text-slate-700 hover:text-sky-600 transition-colors"
                >{{ cfg.email }}</a>
              </div>
            </div>
          </div>
